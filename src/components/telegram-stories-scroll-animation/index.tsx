// in case you have the navigation header, you need to add the height of it
// to get the middle point of the item
    ...
    <SafeAreaView style={{ flex: 1 }} edges={["top"]}>
      ...
      */}
      ...
      <BottomSheet
        ...
        snapPoints={[
          // if you're using a navigation header, you need to add the height of it
          // otherwise, replace 64 with `headerHeight` from the following values
          height - headerHeight - storiesHeight - top - 64,
          height - headerHeight - top - 64,
        ]}>
